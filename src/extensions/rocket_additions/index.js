            ...
            menus: {
                mouseButton: {
                    items: [
                        {
                            text: formatMessage({
                                id: 'rocket_additions.blocks.mouseButton.primary',
                                default: '(0) primary',
                        ...
                        {
                            text: formatMessage({
                                id: 'rocket_additions.blocks.mouseButton.middle',
                                default: '(1) middle',
                        ...
                        {
                            text: formatMessage({
                                id: 'rocket_additions.blocks.mouseButton.secondary',
                                default: '(2) secondary',
...
module.exports = AdditionsBlocks;
